...
/**
 * Classe (camada de visão) com atributos do agendamento de cada servico ({@link ServicoDTO}) feito por um funcionario 
...
public class AgendamentoDTO {
	...
	/**
	 * Construtor da classe {@link AgendamentoDTO} com os atributos DA CLASSE parametrizados.
	 * 
	...
	/**
	 * Construtor da classe {@link AgendamentoDTO} com TODOS os atributos
	 * parametrizados (os atributos da classe e os objetos de outras classes que
	 * estao relacionados com {@link AgendamentoDTO}).
	 * 
	 * @param idAgenda codigo identificador do agendamento
	...
	public String toString() {
		return "AgendamentoDTO [idAgenda=" + idAgenda + ", agendamentoDH=" + agendamentoDH +
	 ...
	 * 
	 * @return {@link String} com as observacoes do cliente.
	 */
