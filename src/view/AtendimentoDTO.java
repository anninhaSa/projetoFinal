...
/**
 * Classe (camada de visão - DTO: Data Transfer Object) com atributos do atendimento de cada {@link ServicoDTO} realizado por um funcionario
 * ({@link FuncionarioDTO}) a um cliente({@link ClienteDTO})
 */
public class AtendimentoDTO {
    ...
    /**
     * Construtor da classe {@link AtendimentoDTO} (inicializa todos os atributos).
     */
    ...
    /**
     * Construtor da classe {@link AtendimentoDTO} com TODOS os atributos parametrizados (os atributos da classe e os objetos de outras 
     * classes que estao relacionados com {@link AtendimentoDTO}).
     * 
     * @param idAtendimento codigo identificador do atendimento
     * @param atendimentoDH data e hora do atendimento
     ...
     */
    public AtendimentoDTO( Integer idAtendimento, String atendimentoDH, ClienteDTO cliente, FuncionarioDTO funcionario,
            ServicoDTO servico ) {
        setIdAtendimento( idAtendimento );
        setAtendimentoDH( atendimentoDH );
        setCliente      ( cliente       );
    ...
    public String toString( ) {
        return "Atendimento [idAtendimento=" + idAtendimento + ", atendimentoDH=" + atendimentoDH + ", cliente=" + cliente +
     ...
     * 
     * @param incDH data e hora de inclusao do atendimento 
     */
     ...
     * 
     * @return data e a hora da alteracao do atendimento
     */
     ...
     * 
     * @param altDH data e a hora da alteracao do atendimento
     */
